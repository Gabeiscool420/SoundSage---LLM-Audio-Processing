...
2. [**completion_handling.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/completion_handling.py)
...
3. [**error_handling.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/error_handling.py)
...
4. [**file_management.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/file_management.py)
    - [x] Implement function for navigating to a specified folder.
    - [x] Implement function for copying files.
    - [x] Implement function for pasting files.

5. **SoundSage Main** [**main.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/main.py)
    - [x] Implement main function that runs the application.
    - [x] Import and use the functions from the other scripts.

6. [**menu_functions.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/menu_functions.py)
    - [ ] Implement functions that get executed when the menu options are selected.

7. [**openai_interaction.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/openai_interaction.py)
    - [x] Implement function for sending user's input to the OpenAI API.
    - [x] Implement function for receiving and processing the response from the OpenAI API.
    - [x] Implement function for parsing task related keywords, ie AutoGain, Directory, Subdirectory, Specified file Identification.
        
8. [**send_button_functionality.py**](https://github.com/Gabeiscool420/SoundSage---LLM-Audio-Processing/blob/SoundSage---LLM-Integration/SoundSage-LLM%20Integration/SoundSage/send_button_funtionality.py)
    - [x] Implement function that gets executed when the "Send" button is clicked.
