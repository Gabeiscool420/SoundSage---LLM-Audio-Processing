...
def extract_info_from_response(response):
    ...
    # Define a list of audiotool keywords to look for (starting with AutoGain)
    audiotool_keywords = ["Gain staging", "Input gain", "Output gain", "Unity gain", "Trim", "Preamp", "Mic preamp",
    ...
    # Define a list of directory/ file management keywords to look for
    directory_keywords = ["Directory", "Folder", "File", "File management", "Organization", "Hierarchy", "Storage",
                          ...
                          "Mastering", "Version control", "Revision history", "Undo", "Redo", "Collaboration",
                          "Sharing",
    ...
    for sent in doc.sents:
        ...
        for keyword in audiotool_keywords:
    ...
    for keyword in audiotool_keywords + directory_keywords + protools_keywords + ableton_keywords + garageband_keywords \
